...
// Initialize the options page and auto-set the Vivaldi URL
document.addEventListener("DOMContentLoaded", function() {
  loadSettings();
  // Auto-detect and replace YOUR_EXTENSION_ID in the Vivaldi instructions
  const extId = chrome.runtime.id;
  const vivaldiUrl = document.getElementById("vivaldi-url");
  if (vivaldiUrl) {
    vivaldiUrl.innerText = "chrome-extension://" + extId + "/redirect.html?q=%s";
  }
});
